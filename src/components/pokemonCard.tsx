  ...
  return (
    <>
        <Tilt >
          <article
            className={
              "cursor-pointer rounded-md h-[320px] w-[240px] [transform-style:preserve-3d] transition-all duration-[0.7s] ease-in " +
          ...
          >
            <div className= " bg-black backdrop-blur-sm bg-opacity-30 rounded-md absolute w-full h-full [backface-visibility:hidden] border-gray-400 border ">
              ...
              <p className="font-pixel text-2xl text-purple-400 font-bold first-letter:uppercase text-center">{indiVidualPokemonData.name}</p>
            </div>
